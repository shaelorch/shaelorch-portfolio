...
export default function CForm() {
  ...
  return ( <ChakraProvider>
        ...
        {setSubmit &&
          <Text fontFamily={'cabin, sans-serif'} fontSize={large}style={{color:'black'}}>Let's Talk!</Text>
        }

        { submit && (

          <Text fontFamily={'cabin, sans-serif'} fontSize={26}>Thank you for contacting me! I look forward to working with you!</Text>)
        }
