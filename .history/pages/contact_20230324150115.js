  ...
  return (
    <div className={styles.contactcont}>
      ...
      <main className={styles.main}>
        ...
        <h1 style={{color:'black', display:'flex' ? "none" : submit : setSubmit}}>Let's talk!</h1>
        <h1 style={{display:'none' ? "flex" : submit}}>Thank you for contacting me! I look forward to working with you!</h1>
     
        <form className={styles.contactform} style={{display:'flex' ? "none" : submit}}>
