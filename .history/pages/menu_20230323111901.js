  ...
  return (
    <div className={styles.workcontainer}>
      ...
      <div className={styles.p}>
        ...
        <Image src="/primary.png" width={900} height={400} style={{borderRadius:20}}></Image>
        <Image src="/secondary.png" width={900} height={400} style={{borderRadius:20}}></Image>
        ...
        <h3 className={styles.h3}>To target this issue, we have created a simple and easy to use activity generator. It suggests new ideas for single parents to do with their children to help spend more quality time with their child and create long lasting memories.</h3>
        </div>
