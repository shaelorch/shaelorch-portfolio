  ...
  return (
    ...
    <div className={styles.logocont}>
      ...
      <div className={styles.p}>
        ...
        <Image src="/primary.png" width={900} height={400} style={{borderRadius:20}} alt="sec"></Image>
        ...
        <h2 className={styles.h3}>The problem we are targeting with MEnU is the issue of mom guilt; specifically the guilt that single mothers feel when they feel that they do not have time to spend quality time with
        their children. Mothers work very hard to make sure they are providing for their child, but sometimes they get so consumed in their work and chores, that sometimes it can weigh on them. </h2>
        </div>
