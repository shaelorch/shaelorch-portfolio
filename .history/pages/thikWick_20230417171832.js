  ...
  return (
    <div className={styles.workcontainer}>
      ...
      <main className={styles.maincontent}>
        ...
        <h3 style={{maringLeft:'10%', marginRight:'20%'}}>For the colour palette I first made a mood board to reflect a neutral, elegant theme. I selected colours that felt luxurious but still neutral.</h3>
