  ...
  return (
    <div className={styles.workcontainer}>
      ...
      <main className={styles.maincontent}>
        ...
        <Image style={{marginBottom:50}} src="/ThikWickStyleguide.jpeg" width={800} height={800} alt="styleguide" ></Image> <h1 style={{color:'black'}}>Style Guide</h1>
      
         
        <h3 >For the colour palette I first made a mood board to reflect a neutral, elegant theme. I selected colours that felt luxurious but still neutral.</h3>
