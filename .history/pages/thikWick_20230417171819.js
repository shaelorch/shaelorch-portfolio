      ...
      <main className={styles.maincontent}>
        ...
        <h3 className={styles.paragraph}>Thik Wick is a website for a local small candle making business.
          ...
          This website was designed to reflect the client’s elegant
           style while utilizing subtle interactions with a simplistic interface. 
        ...
        <Image style={{margin:'8%'}} src="/ThikWickStyleguide.jpeg" width={800} height={800} alt="styleguide" ></Image> <h1 style={{color:'black'}}>Style Guide</h1>
      
         
        <h3 style={{maringLeft:'20%', marginRight:'20%'}}>For the colour palette I first made a mood board to reflect a neutral, elegant theme. I selected colours that felt luxurious but still neutral.</h3>
