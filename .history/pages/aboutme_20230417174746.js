      ...
      <main className={styles.main}>
        ...
        <div className={styles.about}>
            ...
            <div className={styles.imgdiv} style={{marginLeft:"15%", marginRight:"15%"}}>
                ...
                <Image className={styles.headshotmob} alt="headshot" src="/headshot.png" width={300} height={300}/>
                <Image className={styles.circlemob} alt="headshot" src="/circle.png" width={300} height={300}/>
