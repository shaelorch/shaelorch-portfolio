  ...
  return (
    <div className={styles.workcontainer}>
      ...
      <main className={styles.main}>
              ...
              <h3 className={styles.paragraph}>Local Scoop is an app where local and small businesses can go to post and sell their products to a larger audience than just their physical storefront. It is also a place where local buyers can go to discover new small businesses and purchase items or services that they might have not known about otherwise.  </h3>
